...
const defaultMeta = {
  ...
  description: "Create, manage, and share your digital business card with SCC Infotech LLP's AI-powered platform. Build professional digital business cards in minutes.",
  image: 'https://github.com/yash131120/DBC_____logo/blob/main/DBCLOGO_2.png?raw=true',
...
app.get('/c/:slug', async (req, res) => {
  ...
  let meta = { ...defaultMeta, url: `${req.protocol}://${req.get('host')}${req.originalUrl}` };
