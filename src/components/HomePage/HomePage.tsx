// React import not required explicitly with JSX transform; removed unused import.
import { AuthPage } from "../AuthPage";
import NavBar from "./NavBar";
// FeatureCard is used inside FeaturesSection; import removed here to avoid unused import.
...
import SocialAutomationSection from "./SocialAutomation";
// motion is used in subcomponents; not required in this file.
...
// import { OrbitCircle } from "@/components/HomePage/OrbitCircle";

// (icon helper removed as it wasn't used)
...
const HomePage = () => {
  ...
  const handleCopyLink = async () => {
    triggerFireworks();
    const link = "https://businesscard.sccinfotech.com/c/scc";
    try {
  ...
  return (
    <div className="relative">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl gap-8 md:gap-12 relative z-10">
          ...
          <div className="relative flex-1 flex items-center justify-center w-full md:w-auto">
            <div className="relative w-full max-w-sm md:max-w-lg bg-white rounded-3xl shadow-2xl p-3 md:p-5 transform rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              {/* Header */}
              <div
                className="text-base md:text-3xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text mb-1 md:mb-2 tracking-wide"
              ...
              <div className="ml-3">
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 md:py-3 rounded-lg font-semibold hover:shadow-lg transition-shadow text-sm md:text-base"
                >
                  📇 Share My Card
                </motion.button>
              </div>
      ...
      {/* SOCIAL AUTOMATION SECTION (Orbit + Features) */}
