      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Add links to your Google Reviews, testimonials, etc.
          </p>
        </div>
        <button
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewReview({ ...newReview, review_url: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="https://review.sccinfotech.com/{business-name}"
              />
              <p className="text-xs text-gray-500 mt-1">
                Link to your Google Reviews, testimonials page, or any review
                platform
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {reviews.map((review) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1 flex items-center gap-3">
                  ...
                  <input
                    ...
                    value={review.title}
                    onChange={(e) =>
                      updateReviewTitle(review.id, e.target.value)
                    }
              ...
              <p
                className="text-xs text-gray-500 truncate mt-2 mb-4"
                title={review.review_url}
              >
                {review.review_url}
              </p>
              <a
